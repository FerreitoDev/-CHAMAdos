...
export const ReopenTicketModal: React.FC<ReopenTicketModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setApiError(null)
      const updated = await ticketsApi.reopenTicket(ticketId, {
      ...
      if (err instanceof Error) {
        ...
        setApiError('Erro ao reabrir chamado. Tente novamente.')
      }
    } finally {
      setIsSubmitting(false)
    }
      ...
      <div className="bg-card text-card-foreground border border-border rounded-xl shadow-2xl w-full max-w-lg p-6 relative animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-border mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-lg font-semibold tracking-tight">Reabrir Chamado</h2>
              {ticketTitle && (
